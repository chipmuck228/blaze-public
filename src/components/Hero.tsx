    ...
    <section className="relative min-h-[100vh] lg:min-h-[60vh] flex flex-col lg:flex-row bg-hero overflow-hidden pt-20 lg:pt-20 items-center justify-center">
      ...
      <div className="relative z-10 w-full lg:w-1/2 flex flex-col justify-center px-4 sm:px-6 lg:px-12 py-12 lg:py-0">
        <div className="max-w-xl">
          ...
          <h1 className="text-5xl lg:text-7xl font-extrabold text-white leading-[1.1] mb-3 tracking-tight">
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#38bdf8] to-[#2563eb]">BUILD.</span>
          </h1>
          <h1 className="text-5xl lg:text-7xl font-extrabold text-white leading-[1.1] mb-3 tracking-tight">
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#38bdf8] to-[#2563eb]">THINK.</span>
          </h1>
          <h1 className="text-5xl lg:text-7xl font-extrabold text-white leading-[1.1] mb-3 tracking-tight">
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#38bdf8] to-[#2563eb]">LEAD.</span>
          </h1>
          <p className="text-lg text-slate-300 mb-8 leading-relaxed">
          Blaze Robotics Academy develops the next generation of engineers, innovators, and leaders. From first-time builders to world-stage competitors — the foundation we build is the same.
          </p>
