    ...
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          // 移动端：全屏显示
          "inset-0 max-h-screen max-w-full translate-x-0 translate-y-0 rounded-none p-4",
          // 桌面端：居中对话框
          "md:top-[50%] md:left-[50%] md:max-w-[calc(100%-2rem)] md:translate-x-[-50%] md:translate-y-[-50%] md:rounded-lg md:p-6 md:max-w-lg",
          className
        )}
        {...props}
      >
